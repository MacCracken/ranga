...
| `gpu_kernels.cyr` | 347 | `gpu/shaders.rs` (5 of 14, optional) |
...
| `dist/ranga-gpu.cyr` | 9,079 | core + gpu context/buffer (needs mabda 4.0.9) |
...
**1,642 assertions, 0 failures. 0 lint warnings, 0 untracked deferrals.**
