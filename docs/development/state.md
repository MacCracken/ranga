...
| `gpu_kernels.cyr` | 703 | `gpu/shaders.rs` (10 of 14, optional) |
...
| `dist/ranga-gpu.cyr` | 9,413 | core + gpu context/buffer (needs mabda 4.0.9) |
...
**1,655 assertions, 0 failures. 0 lint warnings, 0 untracked deferrals.**
