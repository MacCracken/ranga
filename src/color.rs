...
mod tests {
    ...
    fn srgb_linear_roundtrip() {
        for v in [0u8, 1, 50, 128, 200, 255] {
            ...
            assert!((v as i16 - back as i16).unsigned_abs() <= 1, "v={v} back={back}");
        }
    }

    #[test]
    fn srgba_to_linrgba_black() {
        let c: LinRgba = Srgba { r: 0, g: 0, b: 0, a: 255 }.into();
        assert_eq!(c.r, 0.0);
        assert_eq!(c.g, 0.0);
        assert_eq!(c.b, 0.0);
    ...
    fn srgba_to_linrgba_white() {
        let c: LinRgba = Srgba { r: 255, g: 255, b: 255, a: 255 }.into();
    ...
    #[test]
    fn hsl_from_gray() {
        let hsl: Hsl = Srgba { r: 128, g: 128, b: 128, a: 255 }.into();
